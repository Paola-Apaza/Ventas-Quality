<div class="main-container">
    ...
    <form class="box login" action="" method="POST" autocomplete="off" >
		...
		<div class="field">
			...
			<div class="control">
			    <input class="input" type="text" name="login_usuario" pattern="[a-zA-Z0-9]{5,20}" maxlength="20" required >
			</div>
		</div>
		...
		<div class="field">
		  	...
		  	<div class="control">
		    	<input class="input" type="password" name="login_clave" pattern="[a-zA-Z0-9.-]{8,15}" maxlength="15" required >
		  	</div>
		</div>
